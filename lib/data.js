      ...
      cards: [
        {
          ...
          link: {
            ...
            label: { en: "his LinkedIn", pt: "LinkedIn dele" }
          }
        },
        {
          type: "photo",
          pin: { en: "currently watching", pt: "assistindo agora" },
          // Konoha headband drawn as inline SVG (see engine) — swap for a real
          // photo by dropping /public/naruto.jpg and setting `photo` below.
          photo: null,
          caption: { en: "re-watching Naruto. again.", pt: "revendo Naruto. de novo." }
        },
        {
          type: "anime",
          ...
          desc: {
            en: "When I'm off the terminal I'm usually watching anime. Naruto is the one that stuck — the whole \"hard work beats talent\" idea hits different when you're learning to build software.",
            pt: "Quando não tô no terminal, geralmente tô vendo anime. Naruto é o que ficou — aquela ideia de \"esforço supera talento\" faz mais sentido ainda quando você tá aprendendo a construir software."
          }
        },
        {
          type: "creator",
          ...
          link: {
            ...
            label: { en: "@righi._", pt: "@righi._" }
          }
        },
        {
          type: "teach",
          pin: { en: "side thing", pt: "extra" },
          title: { en: "I teach English too", pt: "Também dou aula de inglês" },
          desc: {
            en: "Explaining grammar to someone turns out to be good practice for explaining code. EN fluent, ES intermediate.",
            pt: "Explicar gramática pra alguém acaba sendo um bom treino pra explicar código. Inglês fluente, espanhol intermediário."
          }
        },
        {
          type: "drive",
