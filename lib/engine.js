    ...
    const headband = `
      <span class="note-band" aria-hidden="true">
        <svg viewBox="0 0 160 120">
          <rect x="0" y="47" width="160" height="26" rx="2" fill="#1c2734"/>
          <rect x="0" y="45" width="160" height="4" fill="#0d141d"/>
          <rect x="0" y="71" width="160" height="4" fill="#0d141d"/>
          <rect x="36" y="33" width="88" height="54" rx="7" fill="#cdd2da"/>
          <rect x="36" y="33" width="88" height="54" rx="7" fill="none" stroke="#8b929c" stroke-width="2"/>
          <circle cx="44" cy="40" r="2.3" fill="#7d848e"/>
          <circle cx="116" cy="40" r="2.3" fill="#7d848e"/>
          <circle cx="44" cy="80" r="2.3" fill="#7d848e"/>
          <circle cx="116" cy="80" r="2.3" fill="#7d848e"/>
          <g transform="translate(80,60)" fill="none" stroke="#2b333d" stroke-width="4.4" stroke-linecap="round" stroke-linejoin="round">
